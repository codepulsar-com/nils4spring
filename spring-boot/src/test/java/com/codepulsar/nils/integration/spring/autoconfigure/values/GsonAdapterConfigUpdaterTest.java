...
public class GsonAdapterConfigUpdaterTest {
  private GsonAdapterConfigUpdater underTest = new GsonAdapterConfigUpdater();

  @Test
  void defaultValues() {
    // Arrange
    var config = GsonAdapterConfig.init(getClass());
    var expected = GsonAdapterConfig.init(getClass());
  ...
  void nonDefaultValues() {
    ...
    var config = GsonAdapterConfig.init(getClass());
    var expected =
        GsonAdapterConfig.init(getClass())
  ...
  private void assertConfig(GsonAdapterConfig actual, GsonAdapterConfig expected) {
