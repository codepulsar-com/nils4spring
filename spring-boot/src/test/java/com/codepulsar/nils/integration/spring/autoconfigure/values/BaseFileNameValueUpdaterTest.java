...
public class BaseFileNameValueUpdaterTest {

  private BaseFileNameValueUpdater underTest = new BaseFileNameValueUpdater();
  ...
  void nullValue() {
    ...
    // Assert
    assertThat(config.getBaseFileName())
        .isEqualTo("com/codepulsar/nils/integration/spring/autoconfigure/values/translation.yaml");
  }
  ...
  void withValue() {
    ...
    // Assert
    assertThat(config.getBaseFileName()).isEqualTo("translation.yaml");
  }
}
