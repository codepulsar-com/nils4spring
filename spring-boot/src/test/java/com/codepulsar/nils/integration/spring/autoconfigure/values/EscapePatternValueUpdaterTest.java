...
public class EscapePatternValueUpdaterTest {

  private EscapePatternValueUpdater underTest = new EscapePatternValueUpdater();
  ...
  void nullValue() {
    ...
    // Assert
    assertThat(config.getEscapePattern()).isEqualTo("[{0}]");
  }
  ...
  void withValue() {
    ...
    // Assert
    assertThat(config.getEscapePattern()).isEqualTo("MISSING - {0}");
  }
}
