...
public class ResourceBundleAdapterConfigUpdaterTest {
  private ResourceBundleAdapterConfigUpdater underTest = new ResourceBundleAdapterConfigUpdater();

  @Test
  void defaultValues() {
    // Arrange
    var config = ResourceBundleAdapterConfig.init(getClass());
    var expected = ResourceBundleAdapterConfig.init(getClass());
  ...
  void nonDefaultValues() {
    ...
    var config = ResourceBundleAdapterConfig.init(getClass());
    var expected =
        ResourceBundleAdapterConfig.init(getClass())
            .baseFileName("test.properties")
  ...
  private void assertConfig(
      ResourceBundleAdapterConfig actual, ResourceBundleAdapterConfig expected) {
