...
public class SuppressErrorsValueUpdaterTest {

  private SuppressErrorsValueUpdater underTest = new SuppressErrorsValueUpdater();
  ...
  void nullValue() {
    ...
    // Assert
    assertThat(config.isSuppressErrors()).isFalse();
  }
  ...
  void trueValue() {
    ...
    // Assert
    assertThat(config.isSuppressErrors()).isTrue();
  }
}
